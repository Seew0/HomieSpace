...
const Navbar = () => {
  ...
  return (
    <nav
      className="my-0 mx-[!important] absolute top-[calc(50%_-_350px)] left-[calc(50%_-_269px)] flex flex-row items-center justify-center gap-[40px] z-[10] text-left text-2xs text-white font-lato"
      id="navbar"
    >

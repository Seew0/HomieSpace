...
import BlueLogoIcon from "../../../components/logos/logoicon";
    ...
    <div className="absolute top-[calc(50%_-_298px)] left-[calc(50%_-_652px)] flex flex-row items-center justify-start gap-[36px]">
      ...
      >
        ...
        <div className="w-[652px] relative text-base leading-[34px] inline-block text-black font-inter">
          <p className="m-0">
            <span className="font-medium font-inter text-black">{`At HomieSpace, we believe in creating seamless and enjoyable experiences for our guests. By creating a `}</span>
          ...
          <p className="m-0 font-medium">&nbsp;</p>
          <p className="m-0 font-medium">
            Join HomieSpace today and embark on a journey where every stay
            feels like home.
          </p>
        </div>

      ...
      <div className="w-[1519px] my-0 mx-[!important] absolute top-[calc(50%_-_495px)] left-[calc(50%_-_761px)] flex flex-row flex-wrap items-start justify-center gap-[122px] z-[0]">
        ...
        >
          ...
          <b className="relative text-11xl tracking-[0.03px] leading-[39px] capitalize font-montserrat text-darkslategray">
            Welcome to HomieSpace Help Desk!
          </b>
        ...
        <div className="h-[723px] flex flex-row items-start justify-center gap-[122px] text-left text-3xl text-midnightblue-300 font-poppins">
          ...
          >
            <div className="w-[752px] h-[175px] flex flex-col items-start justify-start gap-[32px]">
              <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
                ...
                <div className="self-stretch relative text-lg leading-[24px] inline-block h-36 shrink-0 text-dimgray-300">
                  <p className="m-0">
                    HomieSpace is your trusted partner in navigating the dynamic
                  ...
                  <p className="m-0 [text-decoration:underline] text-gray-300">
                    Go to HomieSpace Home Page for more information.
                  </p>
                </div>
              </div>
            ...
            <Accordion className="w-[751px]" sx={{ width: 751 }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
              ...
              <AccordionDetails>
                <Typography>
                  Ensure you are logged in to your HomieSpace account. Navigate
            ...
            <Accordion className="w-[751px]" sx={{ width: 751 }} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  notified via email and through your HomieSpace account. Our
                  ...
                  penalties, including removal from the HomieSpace platform.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion className="w-[751px]" sx={{ width: 751 }} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
              ...
              <AccordionDetails>
                <Typography>{`Ensure that you are logged in to your HomieSpace account. Navigate to the 'My Reservations' section within your account dashboard. Locate the reservation you want to modify in the list of your bookings. Review the changes to your reservation, including any associated costs due to date modifications.  Once you are satisfied with the new dates and any applicable fees, proceed to confirm the changes. `}</Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion className="w-[751px]" sx={{ width: 751 }} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
              <AccordionSummary expandIcon={<Icon>expand_more</Icon>}>
                <Typography>
                  What is the reimbursement policy of HomieSpace?
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  At HomieSpace, we value your peace of mind. Our reimbursement
                  ...
                  natural disasters, government actions), HomieSpace may provide
